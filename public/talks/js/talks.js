...
function getModal(dom) {
  ...
  modalBody.innerHTML = 
    ...
    <iframe class="modal-slides" src="/Digital_Archive/public/talks/data/pdf/slides_example.pdf"></iframe>
    ...
    <img class="modal-images-w" src="/Digital_Archive/public/talks/data/pdf/images_example.jpg"></img>
