function getPGWSlider(classname, imgList) {
  let lis = '';
  for(let i = 0; i < imgList.length; i += 1)
    lis += `<li><img src="${ imgList[i] }" alt="${ imgList[i] }"></li>`;

  return `<div style="width: 90%;"class="container">
      <ul class="${ classname }">
        ${ lis }
      </ul>
    </div>`;
...
// sample <li> for pgwslider
// <li>
    // <a href="http://www.nyc.gov" target="_blank">
        // <img src="/DigitalArchive/public/honor/img/2016_Academic_Sinica_1.jpg" alt="test1">
