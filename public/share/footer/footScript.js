  ...
  '<div class="container-fluid">' +
    '<div class="row">' +
      contactComponent('glyphicon-earphone',
                       '<span style="font-size:16px">+886 (2) 2363-5251 ext. 521</span>') +
      contactComponent('glyphicon-envelope',
                       '<span style="font-size:16px"><a id="footer-email" href="mailto:lslee@cc.ee.ntu.edu.tw">lslee@cc.ee.ntu.edu.tw</a></span>') +
