const titles = {'Profile': '<span id="header-chinese">簡歷</span><br><span id="header-english">Profile</span>',
                'Biography': '<span id="header-chinese">傳記</span><br><span id="header-english">Biography</span>',
                'Honor': '<span id="header-chinese">榮譽</span><br><span id="header-english">Honor</span>',
                'Timeline': '<span id="header-chinese">生平</span><br><span id="header-english">Timeline</span>'};
const modalButtons = {
  'Biography': '<a class="detail-button" data-toggle="modal" data-target="#biographyModal"> more details...</a>',
};
const contents = {
