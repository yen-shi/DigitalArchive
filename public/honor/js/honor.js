timedata = [
  ...
  { 'type': 'international', 'content': ['1993', 'Institute of Electrical and Electronics Engineers (IEEE) Fellow']},
  { 'type': 'international', 'content': ['1995', 'Distinguished Lecturer, IEEE Computer Society']},
  ...
  { 'type': 'international', 'content': ['2007', 'Distinguished Lecturer, IEEE Signal Processing Society']},
  { 'type': 'year', 'content': '2010' },
  { 'type': 'international', 'content': ['2010', 'International Speech Communication Association (ISCA) Fellow']},
  { 'type': 'international', 'content': ['2011', 'Meritorious Service Award, IEEE Signal Processing Society']},
  { 'type': 'national', 'content': ['2013', '台灣大學服務傑出獎']},
  { 'type': 'international', 'content': ['2014', 'Exemplary Global Service Award, IEEE Communication Society']},
...
function createTimeLine(arr) {
  arr.forEach((e) => {
    if (e['type'] == 'year') {
      ...
      year = createElementFromHTML(`<p class="honor-list-year honor-list-font">${e['content'][0]}</p>`);
