...
modalContents = {
  '總統科學獎': `<iframe class="modal-movie" src="https://www.youtube.com/embed/NulBlWIhfaM?rel=0&amp;start=565" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
  ...
  <img class="modal-images-h" src="/Digital_Archive/public/honor/img/2015_President_1.jpg"></img>
  ...
  '中央研究院院士': `<img class="modal-images-w" src="/Digital_Archive/public/honor/img/2016_Academic_Sinica_1.png"></img>
  <p class="modal-caption">Figure 1 - 台大網站首頁校訊</p>
  <img class="modal-images-h" src="/Digital_Archive/public/honor/img/2016_Academic_Sinica_2.jpeg"></img>
  <p class="modal-caption">Figure 2 - 慶賀會照片</p>
  <img class="modal-images-h" src="/Digital_Archive/public/honor/img/2016_Academic_Sinica_3.jpg"></img>
  <p class="modal-caption">Figure 3 - 演講照片</p>
  <h4 class="modal-text-title">電資學院熱烈慶賀李琳山教授 <br> 榮任中研院工程組第一屆唯一國內院士</h4>
  <p class="modal-text">在七月初的中研院院士會議中，選出了工程科學組第一屆共6位院士。本校電資學院李琳山教授為6人之中唯一長期在國內耕耘獲致肯定者，其他5位當選人均為海外學者。</p>
  <p class="modal-text">李教授亦為今日本校工程領域專任教授中唯一榮任中研院院士者。電資學院師生聞訊莫不奔走相告額手稱慶，乃在8月1日舉辦慶賀活動。楊校長親臨致賀，並表示電資學院強將如雲，期待未來有更多人獲國內外各項肯定。李嗣涔前校長亦親臨致賀，並提到李琳山教授在研發會主委任內所完成的臺大第一期邁頂計畫書為臺大邁向頂尖大學描繪出最早的基礎藍圖。 </p>
  <p class="modal-text">李琳山教授希望把所有成果及榮譽歸給過去三十七年來電資學院共兩百多位碩博士生，以及教這些學生各種學問使他們能作最好的研究的全體老師，「這項榮譽是大家的，謝謝大家」。</p>
  <p class="modal-text">李教授長期鑽研語音訊號之電腦處理，為華語語音技術之拓荒者及領航人。他在早年國內研究環境極為艱困之時，考慮華語文之特有結構(例如一字一音、四聲及句型)，探討在這些特有結構下有效處理華語之方法，逐年發展出當時最先進之華語各項技術，建構出基礎技術體系，並將所有成果公開發表，公諸於世。</p>
  <p class="modal-text">他針對華語所有單音作了最早最完整的電腦處理分析，他針對華語文句建立了最早最完整的電腦分析文法及剖析器，首先建立系統化的華語韻律規則並用以合成語音訊號，也首先展示成功的大字彙華語辨識技術；這些都成為今日所有相關技術之基礎。</p>
  <p class="modal-text">李琳山教授並建構出諸多成功的華語實驗系統，其中多數為全球首見。語文之電腦處理為社會進步重要動力之一，他的努力間接帶動海峽兩岸華語文相關領域之研究，由早期篳路藍縷國際學界無人聞問至今日成為世界主流，華語語音技術並已在主流產品中暢銷全球，如Apple Siri、Google Now、Cortana(Microsoft)等。這些全球華人愛用的產品雖有今日尖端技術(如巨量數據、深層學習、雲端資訊、對話及搜尋技術)之加持，然其華語語音部份之核心架構，事實上均建築於他早年原創的基礎體系上。他一向是國際學術界公認對華語語音技術作出作最大開拓性貢獻的領袖人物。</p>
